...
//   static final globalNotifier = GlobalNotifier();
//
...
//         callController.endMeeting("background notification 180", status, back: true, path: directory.path);
...
//         callController.endMeeting("background notification 193", status, back: true, path: directory.path);
...
//         else {
//           CallController callController = Get.put<CallController>(CallController());
//           callController.endMeeting("foreground notification 237", "CANCELLED", path: directory.path);
//         }
//       }
//
...
//         if(globalNotifier.callController.value!=null) {
//           CallController callController = globalNotifier.callController.value;
//           callController.endMeeting("foreground notification 288", status, path: directory.path);
//           storage.remove("calling");
//         }
//         else {
//           final storage = GetStorage();
...
//           await file.writeAsString(status);
//           CallController callController = Get.put<CallController>(CallController());
//           callController.endMeeting("foreground notification 296", status, path: directory.path);
//           // socketMeeting(message.data['ch_id'], status);
//         }
//       }
//
