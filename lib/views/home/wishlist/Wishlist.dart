        ...
        Flexible(
          child: CustomRefreshIndicator(
            ...
            child: Container(
              ...
              child: wishlistController.users.isNotEmpty ? SingleChildScrollView(
                ...
                ListView.separated(
                  ...
                  itemCount: wishlistController.users.length,
                  ...
                  itemBuilder: (buildContext, index) {
                    return getUserDesign(index, wishlistController.users[index]);
                  },
                )

              ) : Center(
                child: Text(
                  "You have not been wishlisted by any user",
