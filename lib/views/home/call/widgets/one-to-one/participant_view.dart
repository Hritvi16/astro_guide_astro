...
import 'package:astro_guide_astro/views/home/call/widgets/common/stats/call_stats.dart';
...
class ParticipantView extends StatelessWidget {
  ...
  const ParticipantView(
      ...
      required this.onStopScreeenSharePressed, required this.image})
      : super(key: key);
        ...
        stream != null
            ...
            : Center(
                child: !isLocalScreenShare
                    ? Container(
                        padding: image.isEmpty ? EdgeInsets.all(avatarTextSize / 2) : null,
                        ...
                        CircleAvatar(
                          ...
                          backgroundImage: NetworkImage(
                            ...
                            participant.displayName.characters.first
                                .toUpperCase(),
                            style: TextStyle(fontSize: avatarTextSize, color: MyColors.black),
                          ),
                        // child: Text(
                        //   participant.displayName.characters.first
                        //       .toUpperCase(),
