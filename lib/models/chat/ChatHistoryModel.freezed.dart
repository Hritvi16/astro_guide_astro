...
class _$_ChatHistoryModel implements _ChatHistoryModel {
  ...
  @override
  String toString() {
    return 'ChatHistoryModel(id: $id, sess_id: $sess_id, k_id: $k_id, status: $status, reason: $reason, started_at: $started_at, ended_at: $ended_at, rate: $rate, amount: $amount, commission: $commission, type: $type, requested_at: $requested_at, waitlisted_at: $waitlisted_at, cancelled_at: $cancelled_at, updated_at: $updated_at, user_id: $user_id, user: $user, rating: $rating, review: $review, reviewed_at: $reviewed_at, anonymous: $anonymous)';
  }
